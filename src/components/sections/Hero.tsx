...
// ─── HIDDEN TRIDENT MARK ───────────────────────────────────────────────────
// Subtle electric trident SVG — used as a watermark/accent.
// Near-invisible at rest, barely perceptible on hover. Can be reused as
// favicon base, embossed print mark, or future brand element.
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[1fr_2fr] lg:gap-20 items-start">
          ...
          <div className="lg:pt-2">
            <span className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ${a.tag}`}>
              {label}
            </span>
  ...
  return (
    <main className="bg-white">
      ...
      <section className="relative overflow-hidden border-b border-slate-100">
        ...
        {/* Hidden trident mark — top right corner, almost invisible */}
              ...
              <div className="grid gap-8 md:grid-cols-2 md:items-center">
                <div>
                  ...
                  <p className="mt-3 text-lg text-slate-300">
                    The Blue Duck Foundation creates transparent, compliant pathways for people who want to support forward-thinking conservation, research, and community work — globally. Get involved as a founding supporter, advisor, or partner.
                  </p>
