            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="py-20 lg:py-28 max-w-3xl">
                ...
                <div className="space-y-12 text-[15px] leading-[1.9] text-slate-500 font-light">
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-light text-slate-900 mb-4">1. Agreement to terms</h2>
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-light text-slate-900 mb-4">2. Use of this website</h2>
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-light text-slate-900 mb-4">3. Donations and payments</h2>
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-light text-slate-900 mb-4">4. Membership</h2>
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-light text-slate-900 mb-4">5. Intellectual property</h2>
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-light text-slate-900 mb-4">6. Third-party links</h2>
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-light text-slate-900 mb-4">7. Disclaimer of warranties</h2>
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-light text-slate-900 mb-4">8. Limitation of liability</h2>
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-light text-slate-900 mb-4">9. Governing law</h2>
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-light text-slate-900 mb-4">10. Changes to these terms</h2>
