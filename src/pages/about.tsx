  ...
  if (empty) {
    return (
      <div className="group relative rounded-2xl border border-dashed border-slate-300 bg-slate-50/50 p-8 transition-all hover:border-slate-400">
        ...
        <Link
          href="/contact"
          className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-slate-600 transition-colors hover:text-slate-900"
        >
          Express interest
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <ValueCard
              number="01"
              title="Integrity"
              desc="We operate with complete financial transparency and scientific honesty. Every dollar and every data point is accounted for — no exceptions."
            />
            <ValueCard
              number="02"
              title="Respect"
              desc="For the land, for wildlife, for landowners, for hunters, and for the communities that have stewarded these places for generations."
            />
            <ValueCard
              number="03"
              title="Restore"
              desc="We don't just protect what remains — we actively work to bring back wetlands, waterways, and habitats that have been lost or degraded over time."
            />
            <ValueCard
              number="04"
              title="Create"
              desc="Innovative conservation takes creativity. We build new tools, new partnerships, and new approaches to meet the challenges facing Texas ecosystems today."
            />
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
            ...
            <div>
              ...
              <div className="mt-8 space-y-8">
                <GoalItem
                  number="01"
                  title="Protect critical wetland habitat"
                  desc="Identify and establish conservation easements, partnerships, and funding streams to protect high-priority wetlands across the Texas Panhandle, coastal prairies, and river bottomlands."
                />
                <GoalItem
                  number="02"
                  title="Restore degraded ecosystems"
                  desc="Fund and execute habitat restoration projects — replanting native vegetation, re-hydrating drained wetlands, and stabilizing eroded waterways — with documented before-and-after outcomes."
                />
                <GoalItem
                  number="03"
                  title="Build a statewide conservation network"
                  desc="Connect hunters, landowners, wildlife agencies, and environmental professionals into a coordinated network that amplifies impact beyond what any single organization can achieve."
                />
                <GoalItem
                  number="04"
                  title="Advance conservation technology"
                  desc="Deploy IoT environmental monitoring, remote sensing, and data tools that give land managers real-time intelligence to make better decisions for wildlife and water quality."
                />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-lg text-slate-600">
                Experienced leaders committed to building a foundation that outlasts all of us.
              </p>
            </div>
            <Link
              href="/contact"
              ...
              <div className="grid gap-8 md:grid-cols-2 md:items-center">
                <div>
                  ...
                  <p className="mt-3 text-lg text-slate-300">
                    The Blue Duck Foundation is actively building its programs, partnerships, and capacity. 
                    Follow our progress or get involved as a founding supporter.
                  </p>
                </div>
