...
function Stars() {
  ...
  return (
    <>
      {positions.map((pos, i) => (
        <div key={i} className="absolute w-1 h-1 rounded-full bg-amber-200/60"
...
function ValuePillar({ number, title, desc }: { number: string; title: string; desc: string }) {
  return (
    <div className="group relative">
      <div className="absolute -top-4 -left-2 text-7xl font-serif text-amber-500/10 select-none group-hover:text-amber-500/20 transition-colors duration-500">{number}</div>
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow bg-white">
        <style>{`
          ...
          :root { --font-serif: 'Playfair Display', Georgia, serif; --font-mono: 'DM Mono', monospace; --font-body: 'Lora', Georgia, serif; }
          ...
          @keyframes featherFloat { 0%, 100% { transform: translateY(0px) rotate(-5deg); } 50% { transform: translateY(-12px) rotate(5deg); } }
        `}</style>
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-stone-950">
          ...
          <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
            ...
            <div className="animate-fade-up-delay-1">
              <div className="font-display text-7xl sm:text-8xl lg:text-9xl font-bold text-white tracking-tight leading-none">Forever</div>
              <div className="font-display text-7xl sm:text-8xl lg:text-9xl font-bold tracking-tight leading-none" style={{ WebkitTextStroke: "1px #d97706", color: "transparent" }}>44</div>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="grid lg:grid-cols-5 gap-16 lg:gap-24 items-start">
              ...
              <div className="lg:col-span-3 space-y-8 font-body-serif text-stone-300 text-lg leading-loose font-light">
                ...
                <p>Born on December 15, 1994, Kaleb lived every day with the qualities that most people only aspire to: <span className="text-amber-400 italic">strength, loyalty, perseverance, and an unbreakable commitment to the people he loved.</span> He was taken from us far too soon on July 27, 2014, at just 19 years old.</p>
                ...
                <div className="border-l-4 border-amber-500/50 pl-8 py-2 my-10">
                  <p className="font-display text-xl text-stone-100 italic">"The Forever 44 Scholarship Fund was created in loving memory of Kaleb Cory. Forever 44 stands for strength, loyalty, perseverance, and the unbreakable bonds of family and friendship."</p>
                </div>
                <p>Through the Blue Duck Foundation, we honor those taken from us too soon and support the families, siblings, and students who choose to carry their legacy forward. We are here not only to preserve the earth, but to preserve the special bonds that connect families and friends across generations and across the world.</p>
                <p className="text-amber-300/90 font-display text-xl italic">Forever 44 lives on through every student who refuses to quit.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-stone-900 py-28">
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="mb-16">
              ...
              <h2 className="font-display text-5xl text-white font-light">What <em className="italic text-amber-400">44</em> Means</h2>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <h2 className="font-display text-5xl text-stone-900 font-light leading-tight">The Forever 44<br /><em className="italic text-amber-600">Scholarship Fund</em></h2>
                ...
                <div className="mt-10 flex gap-4">
                  <Link href="/contact" className="inline-flex items-center justify-center rounded-none border-2 border-stone-900 bg-stone-900 px-8 py-4 font-mono-custom text-xs tracking-widest text-white uppercase transition-all hover:bg-transparent hover:text-stone-900">Apply Now</Link>
                  <Link href="/about" className="inline-flex items-center justify-center rounded-none border-2 border-stone-300 px-8 py-4 font-mono-custom text-xs tracking-widest text-stone-700 uppercase transition-all hover:border-stone-900">About the Foundation</Link>
                </div>
              </div>
              <div>
                <div className="bg-stone-50 border border-stone-200 p-10">
                  ...
                  <p className="font-body-serif text-stone-600 text-sm leading-relaxed mb-6">The Forever 44 Scholarship is awarded to students who carry the qualities Kaleb exemplified. Applicants are evaluated on the following criteria:</p>
                  ...
                  <div className="mt-8 bg-amber-50 border border-amber-200/80 p-5">
                    ...
                    <p className="font-body-serif text-stone-600 text-sm leading-relaxed italic">GPA matters less than character. We are looking for students who refuse to quit — who carry others with them as they rise.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16">
              <div>
                ...
                <h2 className="font-display text-4xl text-white font-light mb-12">A life remembered,<br /><em className="italic text-amber-400">a legacy continued</em></h2>
              ...
              <div className="flex flex-col items-center justify-center">
                <div className="relative">
                  <div className="font-display text-[220px] leading-none font-bold select-none" style={{ WebkitTextStroke: "1px rgba(217,119,6,0.3)", color: "transparent" }}>44</div>
                ...
                <p className="font-body-serif text-stone-400 text-center italic max-w-xs mt-4 leading-relaxed">"We believe legacy is not only something we remember — it is something we continue."</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-28">
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-5xl text-stone-900 font-light">Help us carry it <em className="italic text-amber-600">forward</em></h2>
              <p className="mt-4 font-body-serif text-stone-500 text-lg max-w-xl mx-auto leading-relaxed">Whether you knew Kaleb, believe in what this scholarship stands for, or simply want to support a student who refuses to give up — there is a place for you here.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={card.title} className={`p-10 border ${card.accent ? "bg-stone-900 border-stone-800 text-white" : "bg-stone-50 border-stone-200 text-stone-900"}`}>
                  <h3 className={`font-display text-2xl font-medium ${card.accent ? "text-white" : "text-stone-900"}`}>{card.title}</h3>
                  <p className={`mt-4 font-body-serif text-sm leading-relaxed ${card.accent ? "text-stone-300" : "text-stone-600"}`}>{card.desc}</p>
                  <Link href={card.href} className={`mt-8 inline-flex items-center gap-2 font-mono-custom text-xs tracking-widest uppercase transition-colors ${card.accent ? "text-amber-400 hover:text-amber-300" : "text-stone-700 hover:text-amber-600"}`}>
                    {card.action}
        ...
        <section className="bg-stone-950 py-32">
          <div className="mx-auto max-w-4xl px-6 text-center">
            ...
            <p className="mt-8 font-body-serif text-stone-400 text-lg leading-relaxed max-w-xl mx-auto italic">In memory of Kaleb Cory, December 15, 1994 – July 27, 2014.</p>
            ...
            <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact" className="inline-flex items-center justify-center border-2 border-amber-500 bg-amber-500 px-10 py-4 font-mono-custom text-xs tracking-widest text-stone-950 uppercase transition-all hover:bg-transparent hover:text-amber-400">Apply for the Scholarship</Link>
              <Link href="/about" className="inline-flex items-center justify-center border-2 border-stone-700 px-10 py-4 font-mono-custom text-xs tracking-widest text-stone-300 uppercase transition-all hover:border-stone-400 hover:text-white">About the Foundation</Link>
            </div>
          </div>
        </section>
      </main>
